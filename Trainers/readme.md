...
All trainers follow a shared design pattern: drag-and-drop matching/ordering/classification, sticky answer trays, incremental re-grading, MCQ scenario modes, and a collapsible cheat-sheet panel. Dark mode toggle on every trainer.
