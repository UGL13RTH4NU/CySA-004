...
#### *Repo Author's note: I'm not certain these are ambiguities that an experienced reader would even notice — CompTIA's stated candidate profile assumes several years of hands-on SOC work, and I suspect someone with that background would reconcile these fluidly rather than stumble. I hit them because I don't yet have that context to lean on. I've documented them, and the conclusions I reached (through review and a fair amount of arguing with AI), in case they help others coming to this the same way I am — without that experience and intending personal improvement and employability enhancement.*
